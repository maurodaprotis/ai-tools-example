...
- `ai-tools-setup.sh` links or copies everything into tool-specific locations
...
- Update `AGENTS.md` first, then re-run `ai-tools-setup.sh`
...
- Read `ai-tools-setup.sh` to see how the assistant-specific wiring works
